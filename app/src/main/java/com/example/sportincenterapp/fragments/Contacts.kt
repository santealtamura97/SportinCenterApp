    ...
    override fun onCreateView(
        ...
        if (requireArguments().getInt("cl_contacts_background") == R.color.background_primary_color) {
            return AboutPage(context)
                ...
                .addFacebook("the.medy", resources.getString(requireArguments().getInt("st_contacts_4")))
                .addYoutube("UCdPQtdWIsg7_pi4mrRu46vA", resources.getString(requireArguments().getInt("st_contacts_4")))
                .addInstagram("medyo80", resources.getString(requireArguments().getInt("st_contacts_5")))
                .addGroup(resources.getString(requireArguments().getInt("st_contacts_6")))
